...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 21 03:17:49 2018
...
y_product = np.load('train_data_y_product_one_hot_224.npy')
#y_productBrand = np.load('test_data_224_y_productBrand_one_hot.npy')

X, test_X, Y, test_Y = train_test_split(x_matrix, y_product, 
                                        random_state=1, 
                                        train_size=0.7)
...
class train_model(object):
    def __init__(self, sess, image_size=224, c_dim=3, cate_dim=10, batch_size=4):
        self.sess = sess
    ...
    def train(self):
        ...
        checkpoint_dir = './models/googleNet_product/'
        ...
        for i in range (total_iter):
            ...
            if i == total_iter - 1:
               ...
               saver.save(sess, checkpoint_dir + 'googleNet_product_model.ckpt', global_step=i+1)
