...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 20 00:39:48 2018
...
X, test_X, Y, test_Y = train_test_split(x_matrix, y_brand, 
                                        random_state=1, 
                                        train_size=0.7)
...
class train_model(object):
    def __init__(self, sess, image_size=224, c_dim=3, cate_dim=7, batch_size=4):
        self.sess = sess
    ...
    def train(self):
        ...
        checkpoint_dir = './models/googleNet_brand/'
        ...
        for i in range (total_iter):
            ...
            if i == total_iter - 1:
               ...
               saver.save(sess, checkpoint_dir + 'googleNet_brand_model.ckpt', global_step=i+1)
